...
fraud=pd.read_csv("C:\\Users\\hardi\\OneDrive\\Documents\\Excelr_1\\Python\\Random Forest\\Assignments\\Fraud_check.csv")
...
fraud.tail(10)
colnames = fraud.columns
len(colnames[0:5])
X = fraud[colnames[0:5]]
labels=['0','1']
...
# Accuracy
print ("Accuracy",(124+476)/(124+476+0+0)) #100.00
###################################################################
